...
function(a) {
    a.fn.fluidbox = function(b) {
        ...
        var f, d = this,
            ...
            h = function(a) {
                var b = a.find("img"),
                    ...
                    i = 0,
                    j = 0;
                f > b.data().imgRatio ? (i = h.natHeight < e.height() * c.viewportFill ? h.natHeight : e.height() * c.viewportFill, h.imgScale = i / b.height()) : (j = h.natWidth < e.width() * c.viewportFill ? h.natWidth : e.width() * c.viewportFill, h.imgScale = j / b.width());
                var k = e.scrollTop() - b.offset().top + .5 * b.data("imgHeight") * (b.data("imgScale") - 1) + .5 * (e.height() - b.data("imgHeight") * b.data("imgScale")),
                    l = .5 * b.data("imgWidth") * (b.data("imgScale") - 1) + .5 * (e.width() - b.data("imgWidth") * b.data("imgScale")) - b.offset().left,
                    m = h.imgScale;
                d.css({
                    transform: "translate(" + parseInt(10 * l) / 10 + "px," + parseInt(10 * k) / 10 + "px) scale(" + parseInt(1e3 * m) / 1e3 + ")",
            ...
            k = function(b) {
                if (a(this).hasClass("fluidbox")) {
                    ...
                    0 !== a(this).data("fluidbox-state") && a(this).data("fluidbox-state") ? (d.data("fluidbox-state", 0).removeClass("fluidbox-opened").addClass("fluidbox-closed"), i.open && window.clearTimeout(i.open), i.close = window.setTimeout(function() {
                        a(".fluidbox-overlay").remove(), g.css({
                        ...
                        a("<img />", {
                            ...
                            d.data("natWidth", a(this)[0].naturalWidth).data("natHeight", a(this)[0].naturalHeight), d.append($fbOverlay).data("fluidbox-state", 1).removeClass("fluidbox-closed").addClass("fluidbox-opened"), i.close && window.clearTimeout(i.close), i.open = window.setTimeout(function() {
                                a(".fluidbox-overlay").css({
                                    opacity: 1
                                })
                            }, 10), a(".fluidbox-wrap").css({
                                zIndex: c.stackIndex - c.stackIndexDelta - 1
                            }), g.css({
                                "z-index": c.stackIndex + c.stackIndexDelta
                            }), f.css({
        ...
        c.closeTrigger && a.each(c.closeTrigger, function(b) {
            ...
            if (a(this).is("a") && 1 === a(this).children().length && a(this).children().is("img") && "none" !== a(this).css("display") && "none" !== a(this).parents().css("display")) {
                var d = a("<div />", {
                        "class": "fluidbox-wrap",
                        css: {
                            "z-index": c.stackIndex - c.stackIndexDelta
